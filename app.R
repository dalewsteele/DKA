    ...
    nav_panel(
      ...
      card(
        ...
        card_body(
          ...
          tags$ul(
            tags$li(tags$strong("Initial Bolus:"), " Typically 10-20 mL/kg of 0.9% NaCl over 30 minutes (max 500-1000 mL)"),
            ...
            tags$li(tags$strong("Rate Limits:"), " Avoid exceeding 2× maintenance rate"),
